...
import com.cws.kanvas.wgpu.gpu.GPUComputePipelineDescriptor
...
import com.cws.kanvas.wgpu.gpu.GPUProgrammableStage
...
actual class ComputePipeline actual constructor(
    ...
    actual override fun onCreate() {
        context.call { device ->
            ...
            val computeBindingLayouts = info.computeShader?.info?.bindingLayouts?.list
            ...
            val pipelineLayout = device.createPipelineLayout(GPUPipelineLayoutDescriptor(
                ...
                bindGroupLayouts = computeBindingLayouts,
            ))
