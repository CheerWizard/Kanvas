...
data class NativeDataList<T : INativeData>(
    ...
    constructor(memoryLayout: MemoryLayout = MemoryLayout.KOTLIN, count: Int, factory: () -> T) : this(
        list = MutableList(count) { factory() },
        buffer = NativeBuffer(count * factory().sizeBytes(memoryLayout), memoryLayout)
    )
