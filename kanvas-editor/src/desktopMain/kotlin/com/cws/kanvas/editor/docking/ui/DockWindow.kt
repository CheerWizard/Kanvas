...
import com.cws.kanvas.editor.ui.backgroundOverlay
...
fun DockWindow(
    ...
    LaunchedEffect(restored, state.content, state.onClose) {
        if (restored) {
            ...
            dockWindowState.content = state.content
            dockWindowState.onClose = state.onClose
