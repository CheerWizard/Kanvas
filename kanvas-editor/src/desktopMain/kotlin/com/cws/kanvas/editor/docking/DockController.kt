package com.cws.kanvas.editor.docking
...
import com.cws.kanvas.editor.docking.logic.DockContainerState
import com.cws.kanvas.editor.docking.logic.DockSpaceState
import com.cws.kanvas.editor.docking.logic.DockSpaceSlot
import com.cws.kanvas.editor.docking.logic.DockWindowRepo
import com.cws.kanvas.editor.docking.logic.DockWindowState
import com.cws.kanvas.editor.docking.math.hitRect
import com.cws.kanvas.editor.docking.ui.WindowCoords
import com.cws.kanvas.editor.ui.toDpOffset
import com.cws.kanvas.editor.ui.toOffset
import com.cws.kanvas.editor.ui.toSize
...
abstract class DockController : Controller() {
    ...
    abstract fun switchToFullscreenMode(state: DockWindowState)
    abstract fun switchToWindowMode(state: DockWindowState)
    fun toggleWindowMode(state: DockWindowState) {
        if (state.maximized) switchToWindowMode(state) else switchToFullscreenMode(state)
    }
...
class DockControllerImpl(
    ...
    private fun dock(id: String, parentId: String, slot: DockSpaceSlot) {
        ...
        parentWindow.dockSpace?.hoverSlot(null)
    ...
    override fun switchToFullscreenMode(state: DockWindowState) {
        state.maximized = true
        saveState()
    }

    override fun switchToWindowMode(state: DockWindowState) {
